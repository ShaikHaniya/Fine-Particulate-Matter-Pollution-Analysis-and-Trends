Introduction
------------------------------------------------------------------------------------------------------------
Peer-graded Assignment: EDA data course project2
----------------------------------------------------
...
The following questions and tasks are answerd in this exploratory analysis. For each question/task a single plot is created . Unless specified, you can use any plotting system in R to make your plot.
